...
import { KatakanaFlashcardGame } from "@/components/KatakanaFlashcardGame";
import { KatakanaPronunciationChart } from "@/components/KatakanaPronunciationChart";
...
export default function KatakanaPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl space-y-6 px-5 py-8 md:px-8">
      ...
      {tab === "game" ? <KatakanaFlashcardGame /> : <KatakanaPronunciationChart />}
    </main>
  );
}
